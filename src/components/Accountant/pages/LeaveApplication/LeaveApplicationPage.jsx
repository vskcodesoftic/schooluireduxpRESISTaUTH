               ...
               <form onSubmit={handleSubmit(onSubmit)} className="gap-y-2">
                ...
                <div className="md:flex md:items-center mb-6 justify-center">
                        ...
                        <div className="md:w-1/3  border-b m-2">
                                       <p>Select Leave Type : </p>
                                        <Select options={leaveTypes} className="w-full"/>
                        </div>
                ...
                <div className="md:flex md:items-center mb-6 justify-center">
                          ...
                          <div className="md:w-1/3 border border-green-500">
                            ...
                            <textarea rows="5" className="appearance-none rounded-lg bg-transparent border-none w-full text-gray-700 focus:ring-2 focus:ring-green-600  mr-3 py-1 px-2 leading-tight focus:outline-green-400" id="inline-full-name" placeholder="Reason For Leave" {...register("name")} />
                          </div>   
                 </div>
