...
import IncomeData from '../../DataTables/ViewData/IncomeData'
import IncomeChart from '../../sections/Charts/IncomeChart'

export const CheckIncomePage = () => {
    ...
    return (
        ...
        <div className="bg-white shadow-lg p-5">
            <h1 className="text-center font-bold text-lg">Income in the month of July 2001</h1>
